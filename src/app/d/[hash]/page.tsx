...
export default function PostNativePage() {
  ...
  const handleReply = (comment: Comment) => {
    ...
    setNewComment(`@${comment.first_name} `);
    ...
    <div className={styles.postPageApp}>
          ...
          <div className={styles.navGroup}>
            ...
            <div className={styles.navMenu}>
              {['Newsroom', 'VIP Tiers', 'My Squad', 'General'].map(tag => (
                <button key={tag} onClick={() => router.push('/')} className={styles.navItem}>
      ...
      <form className={styles.stickyCommentBar} onSubmit={submitComment}>
        ...
        <input
          ...
          placeholder={user ? (replyingTo ? `Replying to @${replyingTo.first_name}...` : 'Write a comment...') : 'Log in to comment'}
          value={newComment}
